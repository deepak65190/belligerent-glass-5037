...
import logo from "./desk-logo.png"
function Footer() {
    return (
        <>
            ...
            <div className={style.bigDiv}>
               ...
               <div className={style.logStore}>
                    <div className={style.adrodLogo}></div>
                    <div className={style.adrodLogo}></div>
                    </div>
                ...
                <div className={style.copyRightF}>
                    <div><p className={style.copywrite}>© 2011 - 2022 DeskTime</p></div>
                    <div><p className={style.group}>PART OF <span className={style.draught}>DRAUGIM GROUP</span></p></div>
